...
def restore_from_backup(backup_path):
    ...
    # 既存DBをバックアップ
    if db_path.exists():
        backup_copy = db_path.with_suffix('.db.backup_before_feb12')
...
if __name__ == '__main__':
    import sys
    backup_path = sys.argv[1] if len(sys.argv) > 1 else '/Users/nishiharakeita/Downloads/backup_20260212_110605.json'
